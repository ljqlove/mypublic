...
<div class="main-div">
<form method="post" action="/shangpin" enctype="multipart/form-data">
  <table cellspacing="1" cellpadding="3" width="100%">
    <tr>
      <td class="label">详细ID</td>
      <td><input type="text" name="cid" size="40"/></td>
    </tr>
    <tr>
      <td class="label">图片地址</td>
      <td><input type="file" name="links[]" value="" id="some_name" size="40" multiple /></td>
    </tr>
